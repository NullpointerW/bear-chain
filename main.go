...
func drip() (time.Duration, error) {
	...
	url := "https://bartio-faucet.berachain-devnet.com/api/claim?address={addr}"
	marshal, err := json.Marshal(map[string]string{"address": "{addr}"})
	if err != nil {
		return 0, (err)
	}
	...
	request.Header.Set("authority", "bartio-faucet.berachain-devnet.com")
	request.Header.Set("accept", "*/*")
	request.Header.Set("accept-language", "zh-CN,zh;q=0.9")
	request.Header.Set("cache-control", "no-cache")
	request.Header.Set("content-type", "text/plain;charset=UTF-8")
	request.Header.Set("origin", "https://bartio.faucet.berachain.com")
	request.Header.Set("pragma", "no-cache")
	request.Header.Set("referer", "https://bartio.faucet.berachain.com/")
